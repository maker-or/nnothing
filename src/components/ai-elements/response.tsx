    ...
    return (
      <div
        className={cn(
          ...
          '[&_.katex]:text-gray-100 text-sm [&_.katex-html]:text-gray-100 [&_.katex-display]:text-gray-100',
          '[&_.katex_.base]:text-gray-100 text-sm [&_.katex_.mord]:text-gray-100 [&_.katex_.mbin]:text-blue-300',
          '[&_.katex_.mrel]:text-green-300 text-sm [&_.katex_.mop]:text-yellow-300 [&_.katex_.mpunct]:text-gray-300',
          '[&_.katex-display]:my-6 text-sm [&_.katex-display]:text-center',
          className,
        )}
        {...props}
      >
